                        ...
                        <div className={styles.sectionBody}>
                            ...
                            <div className={styles.item}>
                                ...
                                {/* <div>{personDetails.contacts.phone.value && personDetails.contacts.phone.value}</div> */}
                                {
                                    ...
                                    <div><a href={`tel:${personDetails.data.phone}`}>{personDetails.data.phone}</a></div>
                                }
                            </div>
                            <div className={styles.item}>
                                <div className={`${styles.upperCase} ${styles.bold}`}>email</div>
                                {
                                    ...
                                    <div><a href={`mailto:${personDetails.data.email}`}>{personDetails.data.email}</a></div>
                                }
                            </div>
                        </div>
                    </div>
                            ...
                            <div className={styles.sectionBody}>
                                {
                                    ...
                                    && websoclinks.data.map((elem, index) => {
                                        return <div className={styles.item} key={`link_${index}`}>
                                            <div><a href={elem.link}>{elem.label}</a></div>
                                        </div>
                                    })
                                }
                            </div>
                                        ...
                                        return (
                                            <div className={styles.item} key={`education_${index}`}>
                                                ...
                                                </div>
                                                {
                                                    ...
                                                    <div className={styles.itemRow} dangerouslySetInnerHTML={{ __html: elem.comments }}></div>
                                                }
                                            </div>
                                        )
                                    })
                                            ...
                                            <div className={styles.item} key={`course_${index}`}>
                                                <div className={styles.itemRow}>
                                                    ...
                                                    </div>
                                                    {
                                                        ...
                                                        &&
                                                        <div className={styles.secondColumn}>
                                                            <div className={styles.infoText}><a href={elem.cert} target='_blank' rel="noreferrer">Link to certificate</a></div>
                                                        </div>
                                                    }
                                                </div>
                                            </div>
                                    ...
                                    employmentHistory.data.map((elem, index) => {
                                        return (
                                            <div className={styles.item} key={`employment_${index}`}>
                                                ...
                                                {elem.comments && elem.comments !== '' &&
                                                    <div dangerouslySetInnerHTML={{ __html: elem.comments }}>
                                                    </div>
                                                }
                                            </div>
                                        )
                                                            ...
                                                            <div className={styles.itemRow}>
                                                                <div className={styles.firstColumn}>
                                                                    ...
                                                                    }
                                                                    {
                                                                        ...
                                                                        <div className={styles.infoText}>
                                                                            phone: <a href={`tel:${elem.phone}`}>{elem.phone}</a>
                                                                        </div>
                                                                    }
                                                                </div>
                                                            </div>
