                ...
                <div className={styles.headerDetails}>
                    ...
                    <div className={styles.contact}>
                        ...
                        <div className={styles.contactPhoneEmail}>
                            <div>
                                <a href={`tel:${personDetails.data.phone}`}>{personDetails.data.phone}</a>
                            </div>
                            {
                            ...
                            <div>
                                <a href={`mailto:${personDetails.data.email}`}>{personDetails.data.email}</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    && websoclinks.data.map((el, index) => {
                                        return (
                                            <div className={styles.item} key={`link_${index}`}>
                                                <div><a href={el.link} target={'_blank'} rel="noreferrer">{el.label}</a></div>
                                            </div>
                                        )
                                    })
                                }
                                        ...
                                        return (
                                            <div className={styles.item} key={`education_${index}`}>
                                                ...
                                                <div className={styles.infoText}>{el.period.value}</div>
                                                {
                                                    ...
                                                    <div dangerouslySetInnerHTML={{ __html: el.comments }} >
                                                    </div>
                                                }
                                            </div>
                                        )
