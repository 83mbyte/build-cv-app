...
const AbabMin = forwardRef(function AbabMinRef({ data }, ref) {
            ...
            <div className={styling.bodyContainer}>
                ...
                <SectionContainer id='profile' title="Profile Summary">
                    <div className={styling.sectionItem}>
                        <div className={styling.comments} dangerouslySetInnerHTML={{ __html: sanitizeString(summary.data.value) }}>
                        </div>
                    </div>
                </SectionContainer>
                {/* Profile Summary end */}
                                    ...
                                    <div className={styling.sectionItem} key={`education_${index}`}>
                                        ...
                                        </div>
                                        {
                                            ...
                                            <div className={styling.sectionItemBody}>
                                                <div className={styling.comments} dangerouslySetInnerHTML={{ __html: sanitizeString(elem.comments) }}>
                                                </div>
                                            </div>
                                        }
                                    </div>
                ...
                {/* Hobbies */}
                {
                    ...
                    <SectionContainer id={'hobbies'} title={'Hobbies'}>
                        <div className={styling.sectionItem}>
                            <div className={styling.comments} dangerouslySetInnerHTML={{ __html: sanitizeString(hobbies.data.value) }}>
                            </div>
                        </div>
                    </SectionContainer>
                }
